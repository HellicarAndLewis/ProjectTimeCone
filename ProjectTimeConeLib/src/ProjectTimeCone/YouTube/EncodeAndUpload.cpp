...
namespace ProjectTimeCone {
	namespace YouTube {
		...
		void ytv_on_cmd_executed(VideoEncoderEncodeTask task, void* user) {
		  EncodeAndUpload* ytv = static_cast<EncodeAndUpload*>(user);
		...
		EncodeAndUpload::EncodeAndUpload() 
		  ...
		  ,cb_uploaded(NULL)
		{
		  RX_VERBOSE("YouTubeEncodeAndUpload");
		...
		bool EncodeAndUpload::setup(yt_encode_callback onEncoded, 
		...
		bool EncodeAndUpload::setAudioFile(std::string filename, bool datapath) {
		...
		bool EncodeAndUpload::setFramesHeadDir(std::string dir, bool datapath) {
		...
		bool EncodeAndUpload::setFramesTailDir(std::string dir, bool datapath) {
		...
		bool EncodeAndUpload::encodeFrames(std::string path, bool datapath) {
		...
		void EncodeAndUpload::update() {
		  enc_client.update();
		  yt_client.update();
		}

		bool EncodeAndUpload::removeEncodedVideoFile(YouTubeVideo video) {
		...
		bool EncodeAndUpload::removeInputFrames(VideoEncoderEncodeTask task) {
